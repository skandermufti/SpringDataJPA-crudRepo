...
public class ProduitRestController {
	...
	@ResponseBody
	public Produit addProduit(@PathVariable("produit-id") Produit pu) {
	return produitService.addProduit(pu);
	...
	@ResponseBody
	public Produit modifyProduit(@PathVariable("produit-id") Produit pu) {
		return produitService.updateProduit(pu);
	}
